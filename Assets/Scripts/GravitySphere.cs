...
public class GravitySphere : GravitySource
{
    ...
    [SerializeField][Min(0.0f)] private float innerFalloffRadius = 5.0f;
    [SerializeField][Min(0.0f)] private float innerRadius = 1.0f;
    [SerializeField][Min(0.0f)] private float outerRadius = 10.0f;
    [SerializeField][Min(0.0f)] private float outerFalloffRadius = 15.0f;
